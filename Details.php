...
{
$pid=$_GET['delid'];
$ppic=$_GET['paitentpics'];
$ppicpath="paitentpics"."/".$ppic;
$sql=mysqli_query($conn,"delete from clienttable where ID=$pid");
unlink($ppicpath);
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        <h2>Paitent Details  <b>Management</b></h2>
                    </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
$ret=mysqli_query($conn,"select * from clienttable");
$cnt=1;
...
<!--Fetch the Records -->
                    <tr>
                        ...
                        <td><?php echo $row ['doc'];?></td>
                            ...
                            <a href="Details.php?delid=<?php echo ($row['ID']);?>&&ppic=<?php echo $row['propics'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                            </td>
                    </tr>
                    <?php 
$cnt=$cnt+1;
