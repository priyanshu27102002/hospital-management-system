...
$oldprofilepic="paitentpics"."/".$oldppic;
...
$imgnewfile=$imgnewfile.time().$extension;
// Code for move image into directory
move_uploaded_file($_FILES['paitentpics']['tmp_name'],"paitentpics/".$imgnewfile);
  // Query for data insertion
     $query=mysqli_query($conn, "update clienttable set propics='$imgnewfile' where id='$uid' ");
    if ($query) {
    	//Old pic
...
<input type="hidden" name="oldpic" value="<?php  echo $row['propics'];?>">
	<div class="form-group">
<img src="paitentpics/<?php  echo $row['propics'];?>" width="120" height="120">
		</div>

         <div class="form-group">
        	<input type="file" class="form-control" name="paitentpics"  required="true">
